...
// ============================================
// Data Manager (LocalStorage for CRUD)
// ============================================
const DataManager = {
  getData(key) {
  ...
  // Load data from JSON file to localStorage
...
// ============================================
// Footer Manager - Dynamic footer content from config
// ============================================
const FooterManager = {
  init() {
...
// Helper function for showing images in lightbox with download
